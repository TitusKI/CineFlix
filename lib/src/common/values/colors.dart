...
class AppColors {
  ...
  /// grey background
  static const Color primarySecondaryBackground = Color.fromARGB(255, 0, 0, 2);
  /// main widget color blue
  static const Color primaryElement = Color.fromARGB(255, 216, 61, 61);
  ...
  static const Color primaryElementText = Color.fromARGB(255, 0, 0, 0);
  // main widget text color grey
  static const Color primarySecondaryElementText = Color.fromARGB(255, 200, 200, 200);
